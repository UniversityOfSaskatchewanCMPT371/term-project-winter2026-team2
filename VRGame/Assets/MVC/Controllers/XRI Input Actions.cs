...
public partial class @XRIInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@XRIInputActions()
    {
        ...
        UnityEngine.Debug.Assert(!m_XRILeftHand.enabled, "This will cause a leak and performance issues, XRIInputActions.XRILeftHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftHandInteraction.enabled, "This will cause a leak and performance issues, XRIInputActions.XRILeftHandInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftHandLocomotion.enabled, "This will cause a leak and performance issues, XRIInputActions.XRILeftHandLocomotion.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHand.enabled, "This will cause a leak and performance issues, XRIInputActions.XRIRightHand.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHandInteraction.enabled, "This will cause a leak and performance issues, XRIInputActions.XRIRightHandInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightHandLocomotion.enabled, "This will cause a leak and performance issues, XRIInputActions.XRIRightHandLocomotion.Disable() has not been called.");
